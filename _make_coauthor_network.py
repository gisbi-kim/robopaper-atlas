...
<div class="panel" id="info">
  ...
  <div style="margin-top: 10px;">
    ...
    <div id="comms-panel" style="display:none;">
      ...
      <canvas id="comms-hist" width="252" height="74" style="display:block; width:100%; max-width:252px;"></canvas>
...
function drawCommsHist() {
  ...
  const topPad = 14, bottomPad = 18, leftPad = 2, rightPad = 2, gap = 4;
